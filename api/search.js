// ═══════════════════════════════════════════════════════════════════════════════
// MOTEUR MÎZÂN v18.6 — SERVERLESS NODE.JS · SONNET 3.5 (20240620) · DENSITÉ ABSOLUE
// api/search.js
//
// MODÈLES FIXES (100% stables) :
//   ● Principal  : claude-3-5-sonnet-20240620
//   ● Traducteur : claude-3-haiku-20240307
//   ● URL : new URL(req.url, 'http://localhost') — zéro url.parse()
...
async function _translateQueryToArabic(query) {
  ...
  try {
    const resp = await client.messages.create({
      model: "claude-3-haiku-20240307", max_tokens: 80, temperature: 0,
...
export default async function handler(req, res) {
  ...
  // ── Extraction du query — standard new URL() (Vercel Vert) ──
