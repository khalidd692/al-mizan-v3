...
CHAMP grade_explique — VERDICT FLASH :
INTERDICTION ABSOLUE de generer un <span> de couleur au debut du champ. Le badge visuel est gere par le frontend.
Genere grade_explique EXACTEMENT dans ce format a 4 lignes strictes (utilise les guillemets simples pour le HTML) :

<b>Sources principales :</b> [EXHAUSTIVITE : Liste de TOUS les recueils majeurs ayant rapporte le matn]<br>
<b>Cause globale :</b> [Resume simple et vulgarise : ex. 'Chaine continue et transmetteurs fiables'. ZERO lexique technique complexe ici]<br>
<b>Sceau contemporain :</b> [Verdict final d Al-Albani, Ibn Baz ou Ibn Uthaymin. Si absent → Bouclier des Principes (P1 a P5)]<br>
<b>Statut pratique :</b> [PEUT ETRE CITE EN PREUVE / NE DOIT PAS ETRE PRATIQUE — EN MAJUSCULES]
...
async function analyserUnHadith(r, idx, q, res, wantSSE) {
  ...
  try {
    ...
    if (parsed && r.grade) {
      ...
      // Cas D : grade non classé + IA sans badge → Al-Albani à consulter
      ...
      if (gradeUnknown && !aiGood && !aiBad) {
        ...
        parsed.grade_explique =
          "<b>Sources principales :</b> " + (r.source || "voir Dorar.net") + ".<br>" +
          "<b>Cause globale :</b> Grade non d\u00e9termin\u00e9 par Dorar.net \u2014 v\u00e9rification requise.<br>" +
          "<b>Sceau contemporain :</b> Consulter la Silsilah Sahihah (SS) et Da\u2019ifah (SD) du Cheikh al-Alb\u0101ni (rahimahullah).<br>" +
