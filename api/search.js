...
const SYSTEM_TAKHRIJ =
  ...
  "TERMES DE SIFAT (Attributs divins — traduction litterale obligatoire) : " +
  ...
  "CHAMP isnad_chain — FORMATAGE STRUCTURÉ OBLIGATOIRE : " +
  "Reconstitue la chaine de transmission INTEGRALE de ce hadith, du Sahabi jusqu aux verificateurs contemporains. " +
  "FORMAT STRICT — chaque maillon sur une NOUVELLE LIGNE, separe par des pipes | : " +
  "Maillon [N] | [NOM COMPLET DU RAWI] | [TITRE: Sahabi/Tabi_i/Tabi_Tabi_i/Muhaddith/Compilateur/Verificateur] | [VERDICT JARH: Thiqah/Thiqah_Thabt/Saduq/Da_if/Matruk/Kadhdhab/Adul] | [SIECLE: 7e/8e/9e...21e] " +
  "EXEMPLE OBLIGATOIRE DE FORMAT : " +
  "Maillon 1 | Umar ibn al-Khattab | Sahabi | Adul par Ijma | 7e siecle\\n" +
  ...
  "Maillon 4 | Yahya ibn Said al-Ansari | Muhaddith | Thiqah Thabt | 8e siecle\\n" +
  "Maillon 5 | Sufyan ibn Uyaynah | Muhaddith | Thiqah Hafidh | 8e siecle\\n" +
  "Maillon 6 | Al-Imam Al-Bukhari | Compilateur | Amir al-Mu_minin fil Hadith | 9e siecle\\n" +
  "Maillon 7 | Cheikh Muhammad Nasir ad-Din al-Albani | Verificateur | Muhaddith al-Asr | 20e siecle\\n" +
  "Maillon 8 | Cheikh Abd al-Aziz ibn Baz | Verificateur | Mufti General | 20e siecle\\n" +
  "Maillon 9 | Cheikh Muhammad ibn Salih al-Uthaymin | Verificateur | Imam | 20e-21e siecle " +
  "REGLES ABSOLUES pour isnad_chain : " +
  "1. Commence TOUJOURS par le Sahabi (le Prophete sallallahu alayhi wa sallam est implicite au-dessus). " +
  "2. Inclus TOUS les maillons intermediaires connus (Tabi_i, Tabi_Tabi_i, Muhaddithun). " +
  "3. Inclus le Compilateur (Bukhari, Muslim, Tirmidhi, etc.). " +
  "4. TERMINE TOUJOURS par les Verificateurs contemporains : Al-Albani, puis Ibn Baz, puis Ibn Uthaymin. " +
  "   Ajoute le verdict de chacun sur ce hadith specifique (authentifie/affaibli/invente). " +
  "5. ZERO PROSE. ZERO PHRASE. Format pipe uniquement. " +
  "6. VRAIS NOMS COMPLETS — pas de titres generiques comme Les Savants. " +
  "7. Si Da_if ou Mawdu_ : identifie le maillon faible avec son verdict exact (Da_if, Matruk, Kadhdhab, Munkar, Mudallis). " +
  "8. Minimum 5 maillons (Sahabi + intermediaires + Compilateur + 2 verificateurs). " +
