...
STRUCTURE (9 champs, tous obligatoires) :
{
  "french_text": "...",
  "grade_explique": "...",
...
════════════════ ZONE 2 — L AUDIT SCIENTIFIQUE (SANAD & RIJAL) ════════════════
But : prouver scientifiquement le verdict. 4 PILIERS OBLIGATOIRES.

PILIER 1 — TAKHRIJ (Extraction des sources) :
  Identifier les livres de hadith ou ce texte est rapporte. \
  Indiquer les numeros de hadith si connus. Mentions par les grands Muhaddithin.

PILIER 2 — RIJAL (Analyse des transmetteurs) :
  Chaque maillon de la chaine : nom, generation, verdict des critiques.

PILIER 3 — 'ILAL (Defauts caches) :
  Y a-t-il une 'Illah (Inqita, Tadlis, Idtirab, Shudhudh) dans ce hadith ?

PILIER 4 — JARH WA TA'DIL (Jugement sur les rawis) :
  Verdicts des Imams critiques sur chaque transmetteur principal.

CHAMP isnad_chain (ZONE 2 — PILIER 2) — FORMAT PIPE STRICT :
...
Identifier le maillon defaillant si Da'if (verdict Jarh exact). \
Terminer par Al-Albani | Ibn Baz | Ibn Uthaymin.

CHAMP jarh_tadil (ZONE 2 — PILIERS 3 & 4) :
...
'Illah precise (Inqita, Tadlis, Shudhudh, Jahalah) si Da'if. <br><br> entre rawis.

CHAMP sanad_conditions (ZONE 2 — SYNTHESE DES 5 CONDITIONS) :
...
(Continuite de la chaine — Pilier 1) : [analyse detaillee]. \
<span style='color:#2ecc71;'>ETABLI</span> ou \
<span style='color:#e74c3c;'>ABSENT — [raison + type d Inqita]</span><br><br>
<span style='color:#d4af37;font-weight:bold;'>2. 'ADALAT AR-RUWAT</span> \
(Probite des transmetteurs — Pilier 4) : [analyse]. \
...
(Precision memorielle — Pilier 2) : [analyse]. \
...
(Absence d anomalie — Pilier 3) : [analyse]. \
...
(Absence de defaut cache — Pilier 3) : [analyse]. \
<span style='color:#2ecc71;'>ETABLI</span> ou <span style='color:#e74c3c;'>ABSENT — ['Illah identifiee + Bouclier Principe X]</span>

CHAMP mutabaat (ZONE 2 — AL-MUTABA AT WA ASH-SHAWAHID / VOIES DE RENFORT) :
Ce champ est VITAL pour comprendre les reclassements d Al-Albani (Da'if → Hasan li Ghayrihi). \
Structure obligatoire :

<span style='color:#9b59b6;font-weight:bold;'>AL-MUTABA AT (Renforts de chaine)</span><br>
[Existe-t-il d autres chaines rapportant ce meme matn ? Citer les rawis alternatifs.] \
Exemple : "Mutaba a confirme par Sulayman ibn Musa (Musannaf Ibn Abi Shayba)" ou "Aucune mutaba a identifiee."

<br><br><span style='color:#9b59b6;font-weight:bold;'>ASH-SHAWAHID (Temoins parallelesels)</span><br>
[Existe-t-il d autres hadiths avec un sens similaire qui renforcent ce texte ?] \
Exemple : "Shahid confirme par hadith de Abu Hurayra (Bukhari no.X)" ou "Aucun shahid identifie."

<br><br><span style='color:#9b59b6;font-weight:bold;'>VERDICT DE RENFORT</span><br>
Conclusion : ce hadith est-il renforce au point de passer de Da'if a Hasan li Ghayrihi ? \
Si oui : citer le jugement d Al-Albani ou d Ibn Hajar qui a pris en compte ces renforts. \
Si non : confirmer que le hadith reste Da'if malgre l existence de renforts insuffisants.

════════════════ ZONE 3 — LE TRESOR DES 14 SIECLES (FIQH) ════════════════
But : sens du texte + loi islamique + application pratique.
OBLIGATION : 7 PARAGRAPHES STRUCTURES avec leurs titres HTML.

CHAMP avis_savants (ZONE 3) :
<span style='color:#d4af37;font-weight:bold;font-size:14px;'>\u276e TRESOR DES 14 SIECLES — SCIENCE ET SAGESSE \u276f</span><br><br>

PARAGRAPHE 1 — AL-MA NA AL-IJMALI (Sens global) :
<span style='color:#e8c96a;font-weight:bold;'>\u2739 AL-MA\'NA AL-IJMALI \u2014 Ce que le Prophete \ufdfa a voulu dire</span><br>
Expliquer le sens profond du hadith : quelle verite le Prophete \ufdfa enseigne-t-il ? \
Vocabulaire du matn selon Ibn al-Athir et Ibn Manzur. Contexte de la revelation (Asbab al-Wurud).

PARAGRAPHE 2 — AQWAL AS-SAHABA WA AT-TABI IN (Paroles des Anciens) :
...
Transmission par les Tabi in (Said ibn al-Musayyab, al-Hasan al-Basri, etc.).

PARAGRAPHE 3 — TAHLIL AL-A IMMA (Analyse des Imams fondateurs) :
<span style='color:#5dade2;font-weight:bold;'>\u2739 ANALYSE DES IMAMS FONDATEURS (8e-9e s.)</span><br>
Position de Malik, Ahmad ibn Hanbal, ash-Shafi'i ou Abu Hanifa sur ce hadith. \
Comment l ont-ils utilise dans leur Fiqh ? Divergences entre les ecoles si pertinentes.

PARAGRAPHE 4 — TAWDIH AL-HUFFADH (Precisions des Huffadh medievaux) :
<span style='color:#f59e0b;font-weight:bold;'>\u2739 PRECISIONS DES HUFFADH (13e-15e s.)</span><br>
Ibn Taymiyyah (m.728H) ou Ibn al-Qayyim (m.751H) : commentaire de fond et Fiqh. \
Ibn Hajar al-Asqalani (m.852H) : analyse de Fath al-Bari ou Bulugh al-Maram. \
adh-Dhahabi (m.748H) : precision complementaire si divergente.

PARAGRAPHE 5 — AL-AHKAM AL-MUSTANBATA (Points juridiques) :
<span style='color:#22c55e;font-weight:bold;'>\u2739 AL-AHKAM \u2014 Ce que la Loi islamique tire de ce hadith</span><br>
Quelles regles (Ahkam) les juristes derivent-ils de ce texte ? \
Obligation (Wajib) ? Recommandation (Mustahabb) ? Interdiction (Haram) ? Permission (Mubah) ? \
Conditions et exceptions mentionnees par les Fuqaha.

PARAGRAPHE 6 — AT-TATBIQ AL-AMALI (Application pratique) :
<span style='color:#34d399;font-weight:bold;'>\u2739 AT-TATBIQ AL-AMALI \u2014 Comment le musulman d aujourd hui agit avec ce texte</span><br>
Conseils concrets pour le musulman moderne. \
Que faire si le hadith est Sahih ? Que faire s il est Da'if ? \
Mises en garde pratiques si hadith faible ou invente.

PARAGRAPHE 7 — AT-TAWJIH AL-MU ASIR (Synthese contemporaine) :
<span style='color:#f39c12;font-weight:bold;'>\u2739 SYNTHESE CONTEMPORAINE \u2014 Al-Albani, Ibn Baz, Ibn Uthaymin</span><br>
Al-Albani (m.1420H) : verdict SS/SD + raisonnement methodologique complet. \
Ibn Baz (m.1420H) : position et application. \
Ibn Uthaymin (m.1421H) : explication pedagogique pour les musulmans d aujourd hui. \
Si Da if/Mawdu : <span style='color:#e74c3c;font-weight:bold;'>AVERTISSEMENT FINAL</span> \
...
4.Rawis evalues | 5.Divergences et position d Al-Albani.
...
6.grade_explique SANS gris ? 7.Zone 3 : les 7 paragraphes avec sous-titres ? \
8.AHKAM et TATBIQ presents ? 9.mutabaat presente (Mutaba at + Shawahid + verdict) ? \
10.Bouclier des Principes applique si Albani absent ?`;
...
const DEFAULTS = {
  ...
  mutabaat:
    "L'analyse des voies de renfort (Mutaba'at wa Shawahid) n'a pas pu etre completee. " +
    "Consultez : Fath al-Bari d Ibn Hajar, Nasbur-Rayah d az-Zayla'i " +
    "et les travaux d Al-Albani pour les renforts de ce hadith.",
  avis_savants:
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    if (wantSSE) {
      ...
      // Signal de fin propre : {} pour déclencher l'auto-hide de la barre
