 ...
 * 1. Ce backend DOIT rester en CommonJS strict (require / module.exports).
 * L'ESM (import/export) crashera Vercel à cause de server.js.
 * 2. Le package.json ne doit JAMAIS contenir "type": "module".
 * 3. Le package.json doit figer le moteur sur "node": "20.x".
 * 4. Un fichier .vercelignore doit être à la racine avec "server.js"
 * pour que Vercel n'ignore pas ce dossier api/.
 *******************************************************************/
